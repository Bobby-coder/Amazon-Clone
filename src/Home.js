            ...
            <div className='home'>
                <div className='home__container'>
                    ...
                    <div className='home__option'>
                        ...
                        <Product title='Scuderia Ferrari Race Day Series 1Samsung T7 Touch 1TB Up to 1,050MB/s USB 3.2 Gen 2 (10Gbps, Type-C) External Solid State Drive (Portable SSD) Black (MU-PC1T0K)' price={14000} image={'https://m.media-amazon.com/images/I/81RA-R8WvIL._SL1500_.jpg'} rating={4} />
                    </div>
